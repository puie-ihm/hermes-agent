...
def set_runtime_main(
    ...
    *,
    ...
    global _RUNTIME_MAIN_AUTH_MODE, _RUNTIME_MAIN_SESSION_ID
    global _RUNTIME_MAIN_COMPAT_SNAPSHOT
    runtime = {
...
_MAIN_RUNTIME_FIELDS = (
    "provider", "model", "base_url", "api_key", "api_mode", "auth_mode", "session_id"
)
