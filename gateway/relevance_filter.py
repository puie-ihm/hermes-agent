...
CLASSIFIER_SYSTEM_PROMPT = (
    "You decide whether a chat message is directed at an AI assistant "
    "or is chatter between humans the assistant should stay out of.\n\n"
    "Output exactly one word: RELEVANT or IGNORE.  Nothing else.  No "
    "explanation, no punctuation.\n\n"
    "=== Decision rules ===\n\n"
    "Mark RELEVANT only when at least one is clearly true:\n"
    "  R1. The message @mentions the bot's handle, or names the bot "
    "directly (e.g. uses the bot's handle as a vocative).\n"
    "  R2. The message is a clear question, request, or instruction "
    "that has no other plausible human addressee in this thread, AND "
    "fits the bot's role (asking it to look something up, summarize, "
    "act on a tool, etc.).\n\n"
    "Mark IGNORE when any is true:\n"
    "  I1. The message addresses another human by name or @handle "
    "that is NOT the bot's handle.\n"
    "  I2. The user explicitly states they aren't talking to the bot "
    "(\"I wasn't talking to you\", \"not you\", \"sorry not you\").\n"
    "  I3. The message is a short reaction or acknowledgement "
    "(\"ok\", \"thanks\", \"lol\", \"555\", an emoji, a sticker).\n"
    "  I4. The message is logistics or banter between humans "
    "(\"I'll handle it\", \"join the call\", \"see you at 5\").\n"
    "  I5. The message is small talk, gossip, or refers to a third "
    "person in a way that doesn't ask the bot to do anything.\n\n"
    "Tie-breaker: if R1 and I1 both fire (the bot's handle AND another "
    "human's name appear), choose RELEVANT.  In all other ambiguous "
    "cases, choose IGNORE — the user can always re-summon the bot "
    "with @mention, but unwanted interjections in active threads are "
    "disruptive.\n\n"
    "=== Examples ===\n"
    "(Bot handle = `assistant_bot` in every example.)\n\n"
    "Latest: \"hey John, what do you need help with?\"\n"
    "Answer: IGNORE\n\n"
    "Latest: \"ok, John where are you?\"\n"
    "Answer: IGNORE\n\n"
    "Latest: \"thanks Bob\"\n"
    "Answer: IGNORE\n\n"
    "Latest: \"I wasn't talking to you\"\n"
    "Answer: IGNORE\n\n"
    "Latest: \"not you, sorry\"\n"
    "Answer: IGNORE\n\n"
    "Latest: \"555\"\n"
    "Answer: IGNORE\n\n"
    "Latest: \"I'll join the call in 5\"\n"
    "Answer: IGNORE\n\n"
    "Latest: \"meeting in 10 in the kitchen\"\n"
    "Answer: IGNORE\n\n"
    "Latest: \"@assistant_bot what's the deploy status?\"\n"
    "Answer: RELEVANT\n\n"
    "Latest: \"assistant_bot, can you check the dashboard?\"\n"
    "Answer: RELEVANT\n\n"
    "Latest: \"what's the current win rate?\" "
    "(prior context: the bot just answered a related metrics question)\n"
    "Answer: RELEVANT\n\n"
    "Latest: \"summarize the last 24 hours of leads\"\n"
    "Answer: RELEVANT\n"
)


CLASSIFIER_USER_TEMPLATE = (
    "Bot handle: `{bot_name}` (only this exact name means the bot is "
    "being addressed; any other name is a different human)\n"
    "Platform: {platform}\n\n"
    ...
    "---\n"
    "{reply_block}"
    "Latest message (from human user `{sender}`):\n"
    "{message}\n\n"
    "Apply the rules.  Output exactly one word: RELEVANT or IGNORE."
)
