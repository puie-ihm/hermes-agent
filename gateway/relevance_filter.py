...
CLASSIFIER_SYSTEM_PROMPT = (
    "You are a strict relevance classifier for an AI assistant that lives "
    "in chat rooms alongside human users.\n\n"
    "Decide whether the latest message is **intended for the assistant** "
    "or is **chatter between humans** that the assistant should NOT "
    "respond to.\n\n"
    "Reply with ONLY one word: RELEVANT or IGNORE.\n\n"
    "Mark RELEVANT when:\n"
    "- The message asks a question, requests information, or gives an "
    "instruction the assistant could plausibly act on.\n"
    "- The message continues a topic the assistant was already part of "
    "in the recent context.\n"
    "- The message addresses the assistant by name, role (\"the bot\"), "
    "or via @mention.\n\n"
    "Mark IGNORE when:\n"
    "- Two or more humans are clearly addressing each other (\"@alice\", "
    "\"thanks @bob\", \"Bob, can you...\").\n"
    "- The message is small talk between people unrelated to the "
    "assistant's prior context.\n"
    "- The message is a reaction or acknowledgement (\"ok\", \"thanks\", "
    "\"555\", emoji-only) not directed at the assistant.\n"
    "- The message is logistics between humans (\"I'll handle it\", "
    "\"can you join the call?\").\n\n"
    "When in doubt, prefer RELEVANT — false negatives (missed replies) "
    "are worse than false positives (an extra reply).\n"
)
